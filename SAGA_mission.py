...
def vehicle_setup():
    ...
    # mass properties
    vehicle.mass_properties.max_takeoff               = 140000   # kg
    vehicle.mass_properties.takeoff                   = 140000   # kg
    vehicle.mass_properties.max_zero_fuel             = 103400. # kg  #0.9 * vehicle.mass_properties.max_takeoff
    vehicle.mass_properties.payload                     = 40000.  * Units.kilogram
    ...
    wing.chords.root             = 8.00
    wing.chords.tip              = 1.09
    wing.chords.mean_aerodynamic = 5.235

    wing.areas.reference         = 400
    ...
    fuselage.effective_diameter    = 1.9 #4.0

    fuselage.differential_pressure = 0e4 * Units.pascal # Maximum differential pressure
    ...
    # setup
    turbofan.bypass_ratio      = 9.3
    turbofan.number_of_engines = 4.0
    turbofan.engine_length     = 5.218
    turbofan.nacelle_diameter  = 2.0072
    ...
    # setup
    compressor.polytropic_efficiency = 0.95
    compressor.pressure_ratio        = 1.7
    ...
    turbine.polytropic_efficiency = 0.9
    ...
    thrust.total_design             = 4*120000. * Units.N #Newtons

    #design sizing conditions
    altitude      = 65600.0*Units.ft
    mach_number   = 0.9
    isa_deviation = 0.
    ...
    #compute_engine_geometry(turbofan,None) #FIXME
...
def mission_setup(analyses):
    ...
    segment.altitude_end = 21.668 * Units.km
