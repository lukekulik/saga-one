...
def empty(vehicle):
    ...
    wt_landing_gear = landing_gear(TOW, d_eng, d_fus, V_descent)
    wt_fuselage = tube(S_fus, diff_p_fus, w_fus, h_fus, l_fus, Nlim, wt_zf, wt_wing, wt_propulsion, wing_c_r, TOW)
