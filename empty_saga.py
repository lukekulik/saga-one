...
def empty(vehicle):
    ...
    wt_landing_gear,wt_maingear,gear = landing_gear(TOW, d_eng, h_fus, V_descent)
    wt_fuselage = tube(S_fus, diff_p_fus, w_fus, h_fus,l_nose,l_center,l_tail, l_fus, Nlim, wt_zf, wt_wing, wt_propulsion, wing_c_r, TOW, gear)
