...
def base(analyses):
   ...
   # ------------------------------------------------------------------
    ...
    # segment.process.iterate.conditions.weights = update_weights_sprayer
    segment.aerosol_mass_initial = 0 * Units.kg # mass to be sprayed in this segment
    segment.sprayer_rate = 0  * Units['kg/s'] #1 for mission (3500km)
    ...
    segment.air_speed  = 681. * Units['km/h']
    segment.distance   = 3400 * Units.km

    # segment.conditions.weights.vehicle_mass_rate = 2 * Units['kg/s']

    # segment.process.iterate.conditions.weights = update_weights_sprayer
    segment.aerosol_mass_initial = 40000 * Units.kg # mass to be sprayed in this segment
